...
- **✨ Fix Re-Export Symbol Ambiguity:** Removed duplicate re-exports of core symbols (`logger`, `context`, `audit`, `createLogger`) from `@aegislog/next` to avoid TS2308 collisions in consuming applications.
